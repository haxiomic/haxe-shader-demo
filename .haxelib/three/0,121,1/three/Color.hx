...
@:jsRequire("three", "Color") extern class Color {
	...
	**/
	var b : Float;
	function set(color:ts.AnyOf3<String, Float, Color>):Color;
	...
	**/
	@:overload(function(array:js.lib.ArrayLike<Float>, ?offset:Float):Color { })
	function fromArray(array:Array<Float>, ?offset:Float):Color;
	/**

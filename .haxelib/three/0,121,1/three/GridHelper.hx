...
@:jsRequire("three", "GridHelper") extern class GridHelper extends LineSegments<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>> {
	function new(?size:Float, ?divisions:Float, ?color1:ts.AnyOf3<String, Float, Color>, ?color2:ts.AnyOf3<String, Float, Color>);
	function setColors(?color1:ts.AnyOf3<String, Float, Color>, ?color2:ts.AnyOf3<String, Float, Color>):Void;

...
@:jsRequire("three", "BufferGeometry") extern class BufferGeometry extends EventDispatcher {
	...
	**/
	...
	function setIndex(index:Null<ts.AnyOf2<BufferAttribute, Array<Float>>>):BufferGeometry;
	function setAttribute(name:String, attribute:ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>):BufferGeometry;

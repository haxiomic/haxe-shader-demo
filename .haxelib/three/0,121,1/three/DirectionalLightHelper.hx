...
@:jsRequire("three", "DirectionalLightHelper") extern class DirectionalLightHelper extends Object3D {
	...
	var lightPlane : Line<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>>;
	var targetLine : Line<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>>;

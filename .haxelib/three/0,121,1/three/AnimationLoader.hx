...
@:jsRequire("three", "AnimationLoader") extern class AnimationLoader extends Loader {
	...
	function load(url:String, onLoad:(response:Array<AnimationClip>) -> Void, ?onProgress:(request:js.html.ProgressEvent<js.html.EventTarget>) -> Void, ?onError:(event:js.html.ErrorEvent) -> Void):Void;

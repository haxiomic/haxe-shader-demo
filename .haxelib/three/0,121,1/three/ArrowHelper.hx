...
@:jsRequire("three", "ArrowHelper") extern class ArrowHelper extends Object3D {
	function new(dir:Vector3, ?origin:Vector3, ?length:Float, ?color:ts.AnyOf3<String, Float, Color>, ?headLength:Float, ?headWidth:Float);
	var line : Line<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>>;
	var cone : Mesh<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>>;

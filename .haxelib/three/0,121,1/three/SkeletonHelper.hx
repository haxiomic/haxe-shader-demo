...
@:jsRequire("three", "SkeletonHelper") extern class SkeletonHelper extends LineSegments<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>> {
	function new(object:Object3D);

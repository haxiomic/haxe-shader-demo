...
@:jsRequire("three", "ImageBitmapLoader") extern class ImageBitmapLoader extends Loader {
	...
	function load(url:String, ?onLoad:(response:js.html.ImageBitmap) -> Void, ?onProgress:(request:js.html.ProgressEvent<js.html.EventTarget>) -> Void, ?onError:(event:js.html.ErrorEvent) -> Void):Dynamic;

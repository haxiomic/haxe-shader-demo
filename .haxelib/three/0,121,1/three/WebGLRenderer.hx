...
@:jsRequire("three", "WebGLRenderer") extern class WebGLRenderer {
	...
	**/
	function setOpaqueSort(method:haxe.Constraints.Function):Void;
	/**
		Sets the custom transparent sort function for the WebGLRenderLists. Pass null to use the default reversePainterSortStable function.
	**/
	function setTransparentSort(method:haxe.Constraints.Function):Void;
	/**
	...
	**/
	function setClearColor(color:ts.AnyOf3<String, Float, Color>, ?alpha:Float):Void;
	/**
	...
	**/
	...
	function renderBufferImmediate(object:Object3D, program:WebGLProgram):Void;
	function renderBufferDirect(camera:Camera, scene:Scene, geometry:ts.AnyOf2<Geometry, BufferGeometry>, material:Material, object:Object3D, geometryGroup:Dynamic):Void;
	/**
	...
	**/
	function compile(scene:Object3D, camera:Camera):Void;
	/**
	...
	**/
	function setFramebuffer(value:js.html.webgl.Framebuffer):Void;
	/**

...
@:jsRequire("three", "BoxHelper") extern class BoxHelper extends LineSegments<ts.AnyOf2<Geometry, BufferGeometry>, ts.AnyOf2<Material, Array<Material>>> {
	function new(object:Object3D, ?color:ts.AnyOf3<String, Float, Color>);
